...
<font color=#ff0000>当使用到term 查询的时候，由于是精准匹配，所以查询的关键字在es上的类型，必须是keyword而不能是text，比如你的搜索条件是 ”name”:”蔡虚坤”,那么该name 字段的es类型得是keyword，而不能是text。在分组字段上加上 .keyword</font>

<font color=#0000FF >暂时忽略掉语法，直接看看结果：</font>
